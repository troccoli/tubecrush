    ...
    <form wire:submit.prevent="submit">
        ...
        <div class="mb-6">
            <x-jet-label for="photo" dusk="upload-photo-button"
                         class="inline-flex items-center p-2 pr-4 w-auto border border-transparent rounded bg-indigo-600 text-indigo-100 hover:bg-indigo-700 cursor-pointer transition duration-300">
