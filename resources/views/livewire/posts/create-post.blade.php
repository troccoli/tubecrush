<div>
    <form wire:submit.prevent="submit">
        ...
        <!-- Photo -->
        <div class="mb-6">
            <x-jet-label for="photo" dusk="upload-photo-button" class="inline-flex items-center p-2 pr-4 w-auto border border-transparent rounded bg-indigo-600 text-indigo-100 hover:bg-indigo-700 cursor-pointer transition duration-300">
        ...
        <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 justify-end">
            <x-jet-secondary-button dusk="cancel-button" wire:click="cancelCreate" class="w-full justify-center md:w-auto">{{ __('Cancel') }}</x-jet-secondary-button>
