<div dusk="copy-link-share" x-data="{ shown: false, timeout: null }" class="flex">
    <a dusk="copy-link-share-link" @click.stop.prevent="navigator.clipboard.writeText('{{ $postUrl() }}'); $dispatch('copied-{{ $uniqueId() }}')"
       title="Copy URL"
