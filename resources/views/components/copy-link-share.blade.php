<div dusk="copy-link-share" data-cy="copy-link-share" x-data="{ shown: false, timeout: null }" class="flex">
    <a dusk="copy-link-share-link" data-cy="copy-link-share-link"
