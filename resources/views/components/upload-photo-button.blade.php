<x-jet-label for="photo" dusk="upload-photo-button" data-cy="upload-photo-button"
    ...
    <span class="absolute md:static left-0 inset-y-0 flex items-center pl-3 md:pl-0">
        ...
        <x-heroicons-s-arrow-path wire:loading wire:target="photo" dusk="photo-loading-icon" data-cy="photo-loading-icon"
