<x-jet-label for="photo" dusk="upload-photo-button" cy="upload-photo-button"
    ...
    <span class="absolute md:static left-0 inset-y-0 flex items-center pl-3 md:pl-0">
        ...
        <x-heroicons-s-refresh wire:loading wire:target="photo" dusk="photo-loading-icon" cy="photo-loading-icon"
                               class="animate-reverse-spin w-5 h-5 mr-1"/>
    </span>
    Upload a photo
</x-jet-label>
